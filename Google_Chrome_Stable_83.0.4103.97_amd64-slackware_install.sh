#!/bin/bash
# Ultima actualización: 14/06/2020
cd /
...
tar xzvf google-chrome-stable-83.0.4103.97.tgz
tar czvf google-chrome-stable_current_amd64-83.0.4103.97.tar.gz opt/ usr/ etc/
cd /
mv /tmp/google/google-chrome-stable_current_amd64-83.0.4103.97.tar.gz .
cd /usr/local/
...
mkdir google-chrome
cd google-chrome/
mv /google-chrome-stable_current_amd64-83.0.4103.97.tar.gz .
tar xzvf google-chrome-stable_current_amd64-83.0.4103.97.tar.gz
cd ../
...
echo 'Version=83.0.4103.97 empaquetado de *.deb' >> google-chrome.desktop
...
echo 'Version=83.0.4103.97 empaquetado de .deb' >> README.txt
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/google-chrome/google-chrome-stable_current_amd64-83.0.4103.97.tar.gz
rm -rf /tmp/google/
