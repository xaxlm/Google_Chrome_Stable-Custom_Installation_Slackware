#!/bin/bash
# Ultima actualización: 02/11/2019
cd /
...
tar xzvf google-chrome-stable-78.0.3904.87.tgz
tar czvf google-chrome-stable_current_amd64-78.0.3904.87.tar.gz opt/ usr/ etc/
cd /
mv /tmp/google/google-chrome-stable_current_amd64-78.0.3904.87.tar.gz .
cd /usr/local/
...
mkdir google-chrome
cd google-chrome/
mv /google-chrome-stable_current_amd64-78.0.3904.87.tar.gz .
tar xzvf google-chrome-stable_current_amd64-78.0.3904.87.tar.gz
cd ../
...
echo 'Version=78.0.3904.87 empaquetado de *.deb' >> google-chrome.desktop
...
echo 'Version=78.0.3904.87 empaquetado de .deb' >> README.txt
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/google-chrome/google-chrome-stable_current_amd64-78.0.3904.87.tar.gz
rm -rf /tmp/google/
