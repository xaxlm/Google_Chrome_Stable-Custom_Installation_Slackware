...
tar xzvf google-chrome-stable-60.0.3112.101.tgz
tar czvf google-chrome-stable_current_amd64-60.0.3112.101.tar.gz opt/ usr/ etc/
cd /
mv /tmp/google/google-chrome-stable_current_amd64-60.0.3112.101.tar.gz .
cd /usr/local/
...
mkdir google-chrome
cd google-chrome/
mv /google-chrome-stable_current_amd64-60.0.3112.101.tar.gz .
tar xzvf google-chrome-stable_current_amd64-60.0.3112.101.tar.gz
cd ../
...
echo -ne '\n'
rm -rf /usr/local/$DIRINST/google-chrome/google-chrome-stable_current_amd64-60.0.3112.101.tar.gz
rm -rf /tmp/google/
